import sys
sys.path.append("/home/Aron/code/graph/clusternet/pygcn")
...
from loss_functions import loss_kcenter, loss_modularity, loss_modularity_myloss, loss_modularity_myloss_parallel
...
if make_objectives:
    if args.objective == 'kcenter' or args.objective == 'kcenter_zeroth':
        try:
    ...
    if args.objective == 'modularity' or args.objective == 'modularity_zeroth':
...
my_zeroth_loss_modularity = loss_modularity_myloss.apply
my_zeroth_loss_parallel = loss_modularity_myloss_parallel.apply
...
if args.objective == 'modularity_zeroth':
    loss_fn = my_zeroth_loss_modularity
    test_object = mod_all
    train_object = mod_train
    test_only_object = mod_test
    valid_object = mod_valid
    ...
    valid_object = None
# elif args.objective == 'kcenter_zeroth':
#     loss_fn = my_zeroth_loss_kcenter
#     test_object= obj_test
#     train_object = obj_train
#     test_only_object = None
#     valid_object = None
...
#TRAIN DECISION-FOCUSED-ZEROTH
##############################################################################


num_cores = int(mp.cpu_count())
print("This computer has: " + str(num_cores) + " core")
...
if run_decision:
    for t in range(args.train_iters):
        ...
        if pure_opt:
            ...
            loss = loss_fn(r, bin_adj_all, test_object)
